...
attachWidgetInit(`messageMeetWidget`, initMessageMeetWidget);

export function initMessageMeetWidget(element, {accessToken, refreshToken, onEvent, initialActivity, startCall, toPersonEmail, toPersonId}) {
  ReactDOM.render(
    <Root
...
export default function loadAllWidgets() {
  ...
  for (const widget of widgets) {
    window.ciscospark.widget(widget).messageMeetWidget({
      ...
      refreshToken: widget.getAttribute(`data-refresh-token`) || undefined,
