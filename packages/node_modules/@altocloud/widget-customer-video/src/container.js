...
} from '@altocloud/redux-module-media';
...
/**
 * AltocloudCustomerVideo Component
 */
export class AltocloudCustomerVideo extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (spark && connected && authenticated && registered) {
      ...
      nextProps.listenForIncomingCalls(spark, this.handleEvent);
    }
  }
  ...
  render() {
    ...
    const loadingMessage = spark ? `Trying to connect you, please wait...` : formatMessage(messages.loadingMessage);
...
AltocloudCustomerVideo.propTypes = {
...
)(injectIntl(injectSpark(AltocloudCustomerVideo)));
