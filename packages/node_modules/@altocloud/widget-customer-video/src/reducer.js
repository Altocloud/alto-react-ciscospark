...
// the message reducers include spark, user etc. these should be moved to an independent package
import {reducers as messageReducers} from '@ciscospark/widget-message';
import {reducers as meetReducers} from '@altocloud/widget-meet';
