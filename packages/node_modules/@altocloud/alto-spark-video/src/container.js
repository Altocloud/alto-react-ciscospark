...
class AltoSparkVideoComponent extends Component {
  constructor(props) {
    ...
    this.sparkGuest = new SparkGuest(props.account);
  }
      ...
      return (
        <IntlProvider locale={`en`} messages={messages}>
          <div className={classNames(`widget-component-container`, styles.widgetComponentContainer)}>
            <WidgetCustomerVideo accessToken={this.state.accessToken} refreshToken={this.state.refreshToken} />
          </div>
        </IntlProvider>);
    }
    return (
...
export default connect((state) => ({media: state.media}), () => ({}))(AltoSparkVideoComponent);
