...
=======
>>>>>>> 6e85e91a2b6e2ee7ef05b286020c3f67a9a87118
  componentDidMount() {
    const {
      media,
      sparkInstance
  ...
  handleCall() {
    ...
    const currentUser = users.get(`currentUser`);
    props.callUser({
      userIdOrEmail: toPersonId || toPersonEmail || toPerson,
      locusUrl
    }, sparkInstance)
      .then((call) => {
        // Emit Event
  ...
  handleAnswer() {
    ...
    this.props.acceptIncomingCall(incomingCall).catch(this.catchCallError);
  }
