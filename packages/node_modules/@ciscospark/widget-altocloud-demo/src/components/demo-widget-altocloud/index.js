...
class DemoWidgetAltocloud extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    ...
    if (toPerson) {
      ciscospark.widget(widgetEl).altocloudWidget({
        accessToken: this.getAccessTokenValue(),
        account: `12345`,
...
<script>
  ...
  render() {
    ...
    const loadButtonEnabled = hasToPerson || hasToSpace;
    ...
    return (
      <div>
        <AppBar title="Cisco Spark Altocloud Widget" />
        <div className={classNames(`ciscospark-demo-wrapper`, styles.demoWrapper)}>
          ...
          <Card initiallyExpanded style={{margin: `10px`}}>
            <CardTitle
              ...
              subtitle="The Spark Altocloud widget allows developers to easily incorporate Cisco Spark Altocloud messaging into an application."
              title="Cisco Spark Altocloud Widget Demo"
            />
            <CardText expandable>
              This widget handles coordination between your application and the Spark APIs, and provides components of the Spark Altocloud experience without having to build all of the front end UI yourself.
              <br />
          ...
          <Card initiallyExpanded style={{margin: `10px`}}>
            <CardTitle
              actAsExpander
              showExpandableButton
              subtitle="Cisco Spark Altocloud Widget can open to a space or person."
          ...
          <Card initiallyExpanded style={{margin: `10px`}}>
            <CardTitle
              actAsExpander
              showExpandableButton
              subtitle="Cisco Spark Altocloud Widget can be implemented multiple ways."
...
DemoWidgetAltocloud.propTypes = {
  cookies: instanceOf(Cookies).isRequired
};

DemoWidgetAltocloud.title = `Widget Altocloud`;
DemoWidgetAltocloud.path = `/widget-altocloud-demo`;

export default withCookies(DemoWidgetAltocloud);
