...
const getGuest = (state) => state.guest;
...
export const getSpaceWidgetProps = createSelector(
  [getWidget, getSpark, getGuest, getMedia, getSpaceDetails, getActivityTypes, getCall],
  (widget, spark, guest, media, spaceDetails, activityTypes, call) => ({ // eslint-disable-line max-params
    activityTypes,
    media,
    guest,
